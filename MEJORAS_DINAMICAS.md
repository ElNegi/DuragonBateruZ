...
## Ampliación de combate dinámico

La versión ampliada añade al cooperativo:

- Regla de dados por ronda preservada: 1 → 2 → 3 → 4 → 5 → 6 máximo.
- Resonancias de dados, Flujo y Despertar racial.
- Especialización de raza elegida en el lobby.
- Enemigos con Carga, Drenaje, Estados, Rompeguardia, Furia y Contraataque.
- Jefes con fases y resistencias iniciales a determinados Estados.
- Objetivo opcional compartido de combate.
- Sagas por Acto.
- Sincronía de equipo: alternar acciones distintas entre los dos jugadores puede devolver energía y acelerar el Despertar.
- Botón `Compartir 2 Ki`: transfiere 2 de energía al compañero una vez por ronda.
- Mapa con bifurcaciones sincronizadas: al elegir una ruta, la alternativa queda omitida para los dos clientes.
